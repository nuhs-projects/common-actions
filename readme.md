...
jobs:
  lint:
    uses: nuhs-projects/common-actions/.github/workflows/python-lint.yml@v0.8

  test:
    uses: nuhs-projects/common-actions/.github/workflows/build.yml@v0.8
    needs: lint
    with:
...
jobs:
  get-commit-metadata:
    uses: nuhs-projects/common-actions/.github/workflows/commit-metadata.yml@v0.8
  ...
  generate-k8s:
    uses: nuhs-projects/common-actions/.github/workflows/generate-k8s.yml@v0.8
    needs: build
    with:
  ...
  deploy:
    uses: nuhs-projects/common-actions/.github/workflows/dev-deploy.yml@v0.8
    needs: generate-k8s
    with:
      iam_role: ${{ vars.IAM_ROLE }}
      aws_region: ${{ vars.AWS_REGION }}
